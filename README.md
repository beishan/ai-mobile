...
- The SSD1677 display layer keeps a 48,000-byte previous-frame cache in PSRAM and derives one byte-aligned dirty rectangle from actual framebuffer differences. Unchanged frames are skipped, small changes use one differential partial refresh, and changes covering at least 70% of the panel use a full refresh. This replaces page-specific hard-coded refresh rectangles for button interactions.
