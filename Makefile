...
TEST_SRCS := tests/test_runner.c src/gfx/gfx.c src/platform/epd_frame.c src/platform/input_debounce.c src/platform/sim_display.c src/platform/sdl_display.c src/app/app_state.c src/app/app_persistence.c src/app/reader_library.c src/ui/pages.c src/ui/icons.c src/font/font.c
